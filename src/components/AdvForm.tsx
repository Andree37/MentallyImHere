...
export default function AdvForm() {
    ...
    const onSubmit = useCallback(async (userData: AdvFormValues) => {
        setLoading(true);
                    ...
                    <FormField
                        ...
                        render={({field}) => (
                            <FormItem className="dark:text-white">
                                ...
                                <FormControl>
                                    <Input autoComplete='socialNetwork' className="dark:border-gray-500"
                                           placeholder="@redesocial" {...field} />
                                </FormControl>
                                <FormMessage/>
                            </FormItem>
                        )}
                    ...
                    <FormField
                        ...
                        render={({field}) => (
                            <FormItem className="dark:text-white">
                                ...
                                <FormControl>
                                    <Input autoComplete='IBAN' className="dark:border-gray-500"
                                           placeholder="PT50 ..." {...field}/>
                                </FormControl>
                                <FormMessage/>
                            </FormItem>
                        )}
