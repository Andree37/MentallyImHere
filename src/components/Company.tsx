                ...
                <div className="items-center justify-center space-y-6 md:flex md:gap-6 md:space-y-0">
                    ...
                    <div className="md:w-1/2">
                        ...
                        <p className="text-gray-600 dark:text-gray-300">
                            ...
                            nemo possimus nesciunt dicta veniam aspernatur quam mollitia. Lorem ipsum dolor sit amet
                            consectetur adipisicing elit. Fugit alias sapiente maxime repellendus impedit commodi
                            blanditiis debitis rerum, quisquam aspernatur quod aliquid molestiae eveniet suscipit, natus
                            dolore? Vero, eum voluptatem?
                        </p>
                    </div>
                </div>
            </div>
