                ...
                <div className="relative">
                    <h1 className="text-center text-5xl font-bold text-blue-900 dark:text-white sm:text-6xl lg:text-left lg:text-7xl">
                        ...
                        <span className="relative">
                            ...
                            <div className="inline relative text-secondaryLight md:px-2">
                    ...
                    <div className="relative items-center gap-12 lg:flex">
                        <div className="text-center sm:mx-auto sm:w-11/12 md:mt-12 md:w-4/5 lg:mt-0 lg:mr-auto lg:w-6/12 lg:text-left">
                            <div className="mt-12 text-lg text-gray-600 dark:text-gray-300 sm:text-xl">
                                Ajudamos a encontrar <GenderText text={'@ psicólog@ adequad@'} /> às suas necessidades
                                específicas, em apenas 3 passos.
                            </div>
                            <a href="#email-cta">
                                <button
                                    title="Start buying"
