            ...
            <div className="mx-auto px-4 sm:px-12 xl:max-w-6xl xl:px-0">
                <div className="relative flex flex-wrap items-center justify-between gap-6 lg:gap-0 lg:py-4">
                    <div className="relative z-20 flex w-full justify-between md:px-0 lg:w-max">
                        <p aria-label="ampire logo" className="nav-link flex items-center space-x-2">
                            <svg className="h-7 w-auto" viewBox="0 0 1206 270" fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
                                <g clipPath="url(#clip0_4_24)">
                                    <path className="fill-[#24221B] dark:fill-white" fillRule="evenodd"
                                          clipRule="evenodd"
                  ...
                  <span
                    ...
                    <div className="fixed top-3 right-14 z-20 sm:right-24 lg:hidden">
                        <button aria-label="switche theme"
