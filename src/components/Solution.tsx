        ...
        <div className="mx-auto px-4 sm:px-12 xl:max-w-6xl xl:px-0">
          <div className="text-center">
            ...
            <div className="mx-auto mt-6 text-gray-700 dark:text-gray-300 md:w-3/4 lg:w-3/5">
              ...
              difícil. Entre outras razões, uma das dificuldades é encontrar{" "}
              <TextTransition
                className={"inline"}
                prefix={""}
                text1={"um"}
                text2={"uma"}
              />{" "}
              <GenderText text={"psicólog@"} /> que se adeque às nossas
              necessidades individuais. Nós simplificamos este processo e{" "}
              <GenderText text={"ajudamo-l@"} /> a encontrar o que necessita.
            </div>
            <div
              role="tablist"
              aria-label="tabs"
