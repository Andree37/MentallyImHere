                ...
                <div className="mx-auto px-4 sm:px-12 xl:max-w-6xl xl:px-0">
                    <div className="text-center">
                        ...
                        <div className="mx-auto mt-6 text-gray-700 dark:text-gray-300 md:w-3/4 lg:w-3/5">
                            Em apenas 3 passos, garantimos que tem acesso a <TextTransition className={'inline'}
                                                                                            prefix={''} text1={'um'}
                                                                                            text2={'uma'}/> <GenderText
                            text={'psicólog@'}/> mais adequado para si:
                            <div className='mt-2 text-left'><strong>Passo 1: </strong>Partilhe connosco as suas
                                preferências e
                                necessidades, respondendo a um breve formulário.
                            </div>
                            <div className='text-left'><strong>Passo 2: </strong>Nós realizamos uma análise cuidada das
                                suas respostas e
                                <GenderText text={'conectamo-l@ @ psicólog@'}/> mais adequado/a para si.
                            </div>
                            <div className='text-left'><strong>Passo 3:</strong> Receba as informações que necessita
                                para a
                                1ª sessão com
                                <GenderText text={'@ psicólog@'}/> e inicie o seu processo terapeutico.
                            </div>
                        </div>
                        <div
                            role="tablist"
