                    ...
                    <div className="text-center">
                        ...
                        >
                            ...
                            <button
                                ...
                                className="tab relative block rounded-full py-2.5 px-4 hover:text-primary dark:hover:text-primaryLight"
                            >
                                <span className="m-auto block w-max text-sm font-medium tracking-wider">Conectar</span>
                            </button>
                            <button
                                role="tab"
                                aria-selected="false"
                                            ...
                                            <div className="flex items-center gap-6">
                                                ...
                                                <div className="w-[calc(100%-7.5rem)]">
                                                    ...
                                                    <p className="mt-1 text-gray-600 dark:text-gray-400">
                                                        Fornecendo algumas informações como: preferência por sessões
                                                        presenciais, localização, entre outras.
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
